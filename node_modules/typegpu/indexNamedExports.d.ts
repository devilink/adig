...
export { MissingBindGroupsError, MissingSlotValueError, MissingVertexBuffersError, NotUniformError, ResolutionError, } from './errors.ts';
...
export { isBuffer, isUsableAsUniform, isUsableAsVertex, isUsableAsIndex, isUsableAsStorage, } from './types.ts';
export { isBufferBinding, isBufferShorthand, isMutableBinding, isReadonlyBinding, isUniformBinding, } from './core/buffer/bufferBinding.ts';
...
export type { 
/** @deprecated Import from 'typegpu/~internal' instead */ ShaderGenerator, } from './tgsl/shaderGenerator.ts';
export { 
/** @deprecated Import from 'typegpu/~internal' instead */ WgslGenerator, } from './tgsl/wgslGenerator.ts';
...
export type { Configurable, TgpuGuardedComputePipeline, TgpuRoot, ValidateBufferSchema, ValidateStorageSchema, ValidateUniformSchema, Withable, WithBinding, } from './core/root/rootTypes.ts';
...
export type { RawCodeSnippetOrigin, TgpuRawCodeSnippet, } from './core/rawCodeSnippet/tgpuRawCodeSnippet.ts';
export type { TextureWriteFit, TextureWriteOptions, TgpuTexture, TgpuTextureView, } from './core/texture/texture.ts';
...
export type { TgpuComparisonSampler, TgpuFixedComparisonSampler, TgpuFixedSampler, TgpuSampler, } from './core/sampler/sampler.ts';
export type { TgpuQuerySet } from './core/querySet/querySet.ts';
export type { ExtractBindGroupInputFromLayout, LayoutEntryToInput, TgpuBindGroup, TgpuBindGroupLayout, TgpuLayoutComparisonSampler, TgpuLayoutEntry, TgpuLayoutExternalTexture, TgpuLayoutSampler, TgpuLayoutStorage, TgpuLayoutTexture, TgpuLayoutUniform, } from './tgpuBindGroupLayout.ts';
...
AutoVertexOut, } from './core/function/autoIO.ts';
...
export type TgpuRenderPipelineDescriptor = import('./core/pipeline/renderPipeline.ts').TgpuRenderPipeline.Descriptor;
