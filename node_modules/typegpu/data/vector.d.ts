import type { Vec2b, Vec2f, Vec2h, Vec2i, Vec2u, Vec3b, Vec3f, Vec3h, Vec3i, Vec3u, Vec4b, Vec4f, Vec4h, Vec4i, Vec4u } from './wgslTypes.ts';
/**
 ...
 */
export declare const vec2b: Vec2b;
/**
 ...
 */
export declare const vec3b: Vec3b;
/**
 ...
 */
export declare const vec4b: Vec4b;
export declare const vecTypeToConstructor: {
    readonly vec2f: Vec2f;
    readonly vec2h: Vec2h;
    readonly vec2i: Vec2i;
    readonly vec2u: Vec2u;
    readonly 'vec2<bool>': Vec2b;
    readonly vec3f: Vec3f;
    readonly vec3h: Vec3h;
    readonly vec3i: Vec3i;
    readonly vec3u: Vec3u;
    readonly 'vec3<bool>': Vec3b;
    readonly vec4f: Vec4f;
    readonly vec4h: Vec4h;
    readonly vec4i: Vec4i;
    readonly vec4u: Vec4u;
    readonly 'vec4<bool>': Vec4b;
};
