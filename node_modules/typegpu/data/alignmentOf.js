 ...
 */
const cachedAlignments = new WeakMap();
const cachedCustomAlignments = new WeakMap();
...
export function customAlignmentOf(data) {
 ...
 */
export function PUBLIC_alignmentOf(schema) {
