...
import { ComponentProps } from '../../core/shaders/Line';
 ...
 */
type ShaderComponentProps = BaseShaderProps & Partial<Omit<ComponentProps, 'pointA' | 'pointB' | 'thickness' | 'dashLength' | 'gapLength'>> & {
    pointA?: ComponentProps['pointA'] | PropDriver;
    pointB?: ComponentProps['pointB'] | PropDriver;
    thickness?: ComponentProps['thickness'] | PropDriver;
    dashLength?: ComponentProps['dashLength'] | PropDriver;
    gapLength?: ComponentProps['gapLength'] | PropDriver;
};
/**
