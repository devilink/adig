...
import { ComponentProps } from '../../core/shaders/MeshGradient';
 ...
 */
type ShaderComponentProps = BaseShaderProps & Partial<Omit<ComponentProps, 'smoothness' | 'variation' | 'swirl' | 'drift' | 'wrapping' | 'seed'>> & {
    ...
    wrapping?: ComponentProps['wrapping'] | PropDriver;
