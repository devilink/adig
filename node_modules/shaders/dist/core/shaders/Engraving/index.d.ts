...
import { transformAngle, transformColor, transformPosition } from '../../utilities/transformations';

export interface ComponentProps {
    /**
     * The engraving cut: a single line plate, cross-hatched plates building up the shadows, or one continuous spiral
     *
     * Accepts one of: `"line"`, `"crosshatch"`, `"spiral"`.
     * @default "crosshatch"
     */
    style: string;
    /**
    ...
    /**
     * How strongly the image brightness displaces the lines — the engraved 
     *
     * @default 0.6
     */
    relief: number;
