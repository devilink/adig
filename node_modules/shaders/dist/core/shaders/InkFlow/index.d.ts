...
export interface ComponentProps {
     ...
     *
     * Accepts one of: `"rainbow"`, `"single"`, `"custom"`.
     * @default "rainbow"
     */
    colorMode: string;
    /**
     ...
     *
     * Accepts a number between 0.05 and 4.
     * @default 0.5
     */
    decay: number;
    /**
...
export declare const splatKernel: import('typegpu').TgpuFn<(cx: d.U32, cy: d.U32) => d.Void>;
export declare const curlKernel: (cx: number, cy: number) => void, vorticityKernel: (cx: number, cy: number) => void, divergenceKernel: (cx: number, cy: number) => void, jacobiKernel: (cx: number, cy: number) => void, gradSubtractKernel: (cx: number, cy: number) => void, advectVelKernel: (cx: number, cy: number) => void, copyVelKernel: (cx: number, cy: number) => void, advectDyeKernel: ((cx: number, cy: number) => void) | undefined, copyDyeKernel: ((cx: number, cy: number) => void) | undefined;
