...
export declare const initKernel: import('typegpu').TgpuFn<(cx: d.U32, cy: d.U32) => d.Void>;
export declare const forceKernel: import('typegpu').TgpuFn<(cx: d.U32, cy: d.U32) => d.Void>;
...
export declare const colorRestoreKernel: import('typegpu').TgpuFn<(cx: d.U32, cy: d.U32) => d.Void>;
