...
export interface ComponentProps {
     ...
     *
     * Accepts one of: `"alpha"`, `"bright"`, `"dark"`, `"red"`, `"green"`, `"blue"`.
     * @default "bright"
     */
     ...
     *
     * Accepts one of: `"grid"`, `"quadtree"`, `"mosaic"`.
     * @default "mosaic"
     */
    layout: string;
    /**
     ...
     *
     * Accepts a number between 24 and 800.
     * @default 400
     */
    cellSize: number;
    /**
     ...
     *
     * Accepts a number between 0.5 and 12.
     * @default 1.5
     */
    lineWidth: number;
    /**
     ...
     *
     * Accepts a number between 0 and 40.
     * @default 0
     */
    cornerRadius: number;
    /**
     ...
     *
     * Accepts one of: `"none"`, `"dimensions"`, `"percentage"`.
     * @default "none"
     */
    labelMode: string;
    /**
     ...
     *
     * Accepts one of: `"bottom-left"`, `"bottom-right"`, `"top-left"`, `"top-right"`.
     ...
     *
     * Accepts a number between 0 and 30.
     * @default 0
     */
    labelRadius: number;
    /**
