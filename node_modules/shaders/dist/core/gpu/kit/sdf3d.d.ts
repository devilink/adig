...
export declare const sdMetaballs: import('typegpu').TgpuFn<(p: d.Vec3f, b0: d.Vec3f, b1: d.Vec3f, b2: d.Vec3f, b3: d.Vec3f, b4: d.Vec3f, b5: d.Vec3f, b6: d.Vec3f, b7: d.Vec3f, r: d.F32, k: d.F32) => d.F32>;
 ...
 */
export declare function buildRaymarchedFieldFn(sdfFn: BakedSdf, patternMode?: SurfacePatternMode, chordMode?: ChordMode): import('typegpu').TgpuFn<(fuv: d.Vec2f, rot: d.WgslStruct<{
    cx: d.F32;
    sx: d.F32;
    cy: d.F32;
    sy: d.F32;
...
export declare function buildRaymarchedField(sdfFn: BakedSdf, patternMode?: SurfacePatternMode, chordMode?: ChordMode): import('typegpu').TgpuFn<(fuv: d.Vec2f, rot: d.WgslStruct<{
    cx: d.F32;
    sx: d.F32;
    cy: d.F32;
    sy: d.F32;
...
export declare function buildFieldSampleGraphArgs(): {
    ...
    fieldSampleGradArg: import('typegpu').TgpuFn<(uv: d.Vec2f, field: d.WgslTexture2d<d.F32>, originX: d.F32, originY: d.F32, spanX: d.F32, spanY: d.F32, activeResF: d.F32, rBound: d.F32) => d.Vec4f>;
 ...
 */
export declare function resolveShapeFieldSampler(params: GpuFragmentParams, options?: ShapeFieldSamplerOptions): ShapeFieldSamplerResult;
 ...
 */
export declare function createVolumetricFieldComputeNode(params: GpuFragmentParams, getShapeConfig: () => unknown, patternMode?: SurfacePatternMode, chordMode?: ChordMode): {
    outputs: {
...
export declare const eulerRotatePacked: import('typegpu').TgpuFn<(p: d.Vec3f, rp0: d.Vec4f, rp1: d.Vec4f) => d.Vec3f>;
export declare const paramSphereSdf: import('typegpu').TgpuFn<(p: d.Vec3f, rp0: d.Vec4f, rp1: d.Vec4f, _rp2: d.Vec4f, _t: d.F32) => d.F32>;
/** Spherical (longitude/latitude) surface parameterization. */
export declare const sphereSurfaceUV: import('typegpu').TgpuFn<(h: d.Vec3f, _n: d.Vec3f, rp0: d.Vec4f, rp1: d.Vec4f, _rp2: d.Vec4f, _t: d.F32) => d.Vec2f>;
export declare const paramTorusSdf: import('typegpu').TgpuFn<(p: d.Vec3f, rp0: d.Vec4f, rp1: d.Vec4f, _rp2: d.Vec4f, _t: d.F32) => d.F32>;
/** Toroidal (ring angle / tube angle) surface parameterization. */
export declare const torusSurfaceUV: import('typegpu').TgpuFn<(h: d.Vec3f, _n: d.Vec3f, rp0: d.Vec4f, rp1: d.Vec4f, _rp2: d.Vec4f, _t: d.F32) => d.Vec2f>;
export declare const paramBoxSdf: import('typegpu').TgpuFn<(p: d.Vec3f, rp0: d.Vec4f, rp1: d.Vec4f, rp2: d.Vec4f, _t: d.F32) => d.F32>;
/** Dominant-face cube projection: picks the face by the largest |normal| axis, scaled to 0–1. */
export declare const boxFaceUV: import('typegpu').TgpuFn<(h: d.Vec3f, n: d.Vec3f, rp0: d.Vec4f, rp1: d.Vec4f, rp2: d.Vec4f, _t: d.F32) => d.Vec2f>;
export declare const paramCapsuleSdf: import('typegpu').TgpuFn<(p: d.Vec3f, rp0: d.Vec4f, rp1: d.Vec4f, _rp2: d.Vec4f, _t: d.F32) => d.F32>;
/** Cylindrical (azimuth / axial span) surface parameterization. */
export declare const capsuleSurfaceUV: import('typegpu').TgpuFn<(h: d.Vec3f, _n: d.Vec3f, rp0: d.Vec4f, rp1: d.Vec4f, _rp2: d.Vec4f, _t: d.F32) => d.Vec2f>;
export declare const paramMobiusSdf: import('typegpu').TgpuFn<(p: d.Vec3f, rp0: d.Vec4f, rp1: d.Vec4f, rp2: d.Vec4f, _t: d.F32) => d.F32>;
/** Möbius-band (ring angle / half-twisted width) surface parameterization. */
export declare const mobiusSurfaceUV: import('typegpu').TgpuFn<(h: d.Vec3f, _n: d.Vec3f, rp0: d.Vec4f, rp1: d.Vec4f, _rp2: d.Vec4f, _t: d.F32) => d.Vec2f>;
export declare const paramTwistedRibbonSdf: import('typegpu').TgpuFn<(p: d.Vec3f, rp0: d.Vec4f, rp1: d.Vec4f, _rp2: d.Vec4f, t: d.F32) => d.F32>;
/** Twisted-ribbon (along-spine / across-width) surface parameterization. */
export declare const twistedRibbonSurfaceUV: import('typegpu').TgpuFn<(h: d.Vec3f, _n: d.Vec3f, rp0: d.Vec4f, rp1: d.Vec4f, _rp2: d.Vec4f, t: d.F32) => d.Vec2f>;
/**
 ...
 */
export declare function packedParamExtraFields(prefix: string, initials: number[][]): Record<string, {
    schema: d.Vec4f;
    initial: number[];
}>;
